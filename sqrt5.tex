...
{\bf rank} & $\#\{${\bf isogeny classes }$\}$ &  $\#\{$ {\bf isom. classes }$\}$ &{\bf smallest norm conductor} \\\hline
 $0$  & $745$  & $2172$ & $31$\\\hline
...
$\#\{$ {\bf isom. classes }$\}$ & 3191 & 84 & 43 & 16 & 2 & 2 \\\hline
\end{tabular}
\end{table}
\end{center}
...
\begin{tabular}{|c | c | c |}
\hline 
\textbf{\emph{n}} &{\bf First curve $E$ having $|\Sha(E/F)| = n$ }& {\bf Norm of conductor of $E$} \\
\hline 
...
\begin{center}
\begin{table}[h]
\caption{CM j-invariants for curves of norm conductor up to 1831\label{table:counts}}
...
$j_3$ & $ 287496$ \\\hline
$j_4$ & $1728$ \\\hline
$j_5$ & $-85995a - 52515$ \\\hline
$j_6$ & $85995a - 138510$ \\\hline
$j_7$ & $16554983445a + 10231546590$ \\\hline
$j_8$ & $-16554983445a + 26786530035$ \\\hline
$j_9$ & $-54000$ \\\hline
\end{tabular}
\end{table}
\end{center}
...
\begin{center}
\begin{table}[h]
\caption{Curves over $\Q(\sqrt{5})$ with CM  and norm conductor up to 1831 \label{table:counts}}
\begin{tabular}{|c|l|l|l|}\hline
{\bf Conductor} & {\bf a-invariants} & {\bf j-invariant} &{\bf rank} \\\hline
 $9$ & $\left[1, -1, a, -2a, a\right]$ & $j_5$ & 0 \\\hline %good
 %['81a', 'a1', 81, 9, [1, -1, a, -2*a, a]] -85995*a - 52515 0
 $9$ & $\left[1, -1, a + 1, a - 2, -2a + 1\right]$ & $j_6$ & 0 \\\hline  %good
 %['81a', 'a2', 81, 9, [1, -1, a + 1, a - 2, -2*a + 1]] 85995*a - 138510 0
$9$ & $\left[a, -a - 1, a, -128a - 80, 921a + 569\right]$ & $j_7$ & 0 \\\hline %good
%['81a', 'a3', 81, 9, [a, -a - 1, a, -128*a - 80, 921*a + 569]] 16554983445*a + 10231546590 0
$9$ & $\left[a + 1, 1, 0, 129a - 207, -793a + 1283\right]$ & $j_8$ & 0\\\hline %good
%['81a', 'a4', 81, 9, [a + 1, 1, 0, 129*a - 207, -793*a + 1283]] -16554983445*a + 26786530035 0
$9$ & $\left[a, -a - 1, a + 1, -1153a - 719, -21854a - 13501\right]$ & $j_7$& 0 \\\hline %good
%['81a', 'a5', 81, 9, [a, -a - 1, a + 1, -1153*a - 719, -21854*a - 13501]] 16554983445*a + 10231546590 0
$9$ & $\left[a + 1, 1, 1, 1153a - 1871, 23006a - 37225\right]$ & $j_8$ & 0 \\\hline %good
%['81a', 'a6', 81, 9, [a + 1, 1, 1, 1153*a - 1871, 23006*a - 37225]] -16554983445*a + 26786530035 0
$9$ & $\left[1, -1, a, 13a - 15, 20a - 26\right]$ & $j_6$& 0 \\\hline %good
%['81a', 'a7', 81, 9, [1, -1, a, 13*a - 15, 20*a - 26]] 85995*a - 138510 0
$9$ & $\left[1, -1, a + 1, -14a - 2, -21a - 6\right]$ & $j_5$ & 0 \\\hline %good
...
$27$ & $\left[0, 0, a + 1, 0, -a\right]$ & $j_2$& 0 \\\hline %good
%['729a', 'd1', 729, 27, [0, 0, a + 1, 0, -a]] 0 0
$27$ & $\left[0, 0, a + 1, 0, 6a - 145\right]$ & $j_2$ & 0\\\hline %good
%['729a', 'd2', 729, 27, [0, 0, a + 1, 0, 6*a - 14]] 0 0
$27$ & $\left[0, 0, a, 0, -7a - 7\right]$ & $j_2$ & 0 \\\hline %good
%[729, 27, 0, 0, [0, 0, a, 0, -7*a - 7]]
$27$ & $\left[0, 0, a, 0, 0\right]$ & $j_2$ & 0 \\\hline %good
...
$32$ & $\left[0, 0, 0, -a - 1, 0\right]$ & $j_4$ & 0 \\\hline %good
%['1024a', 'j1', 1024, 32, [0, 0, 0, -a - 1, 0]] 1728 0
$32$ & $\left[0, 0, 0, -11a - 11, -28a - 14\right]$ & $j_3$ & 0\\\hline %good
%['1024a', 'j2', 1024, 32, [0, 0, 0, -11*a - 11, -28*a - 14]] 287496 0
$32$ & $\left[0, 0, 0, -11a - 11, 28a + 14\right]$ & $j_3$& 0 \\\hline %good
%['1024a', 'j3', 1024, 32, [0, 0, 0, -11*a - 11, 28*a + 14]] 287496 0
$32$ & $\left[0, 0, 0, 4a + 4, 0\right]$ & $j_4$ & 0\\\hline %good
...
{\bf size}                           & 1 & 2  & 3 & 4  & 6 & 8 & 10 & total \\ \hline
$\#\{ $ {\bf isogeny classes } $\}$ & 2 & 21 & 3 & 20 & 8 & 9 & 1  & 64 \\\hline
\end{tabular}
\end{table}
\end{center}
...
{\bf torsion structure}    & {\bf $\#\{\text{ isom. classes }\}$} \\\hline
1                    & 27 \\\hline
$\Z/2\Z$             & 82 \\\hline
$\Z/3\Z$             & 11 \\\hline
$\Z/4\Z$             & 20 \\\hline
...
{\bf Norm} & {\bf $a$-invariants} &{\bf $j$-invariant} \\\hline
...
\begin{center}
\begin{tabular}{|c|l|}\hline
{\bf Field} & $D$ so $H_D$ has roots in field \\\hline
