...
\left(-2 \varphi{}\right)x$. Using methods of Halberstadt and Kraus
\cite{halb_kraus:XE7}, Fisher then used a \textsc{Magma} \cite{magma} program to
find rational points on an appropriate twist of $X(7)$, and fortunately, our
curve $E$ was found.
