...
large enough to distinguish newforms. In some cases we will need far more
...
Table~\ref{table:tor-counts} gives the number of curves with each
...
Table~\ref{table:sha-counts} gives the number of curves in our data
having each order of $\Sha$, and Table~\ref{table:sha} gives a minimal
conductor curve exhibiting each of these orders. 
...
\begin{center}
\begin{table}[h]
\caption{Torsion subgroups for curves with norm conductor up through 1831\label{table:torsion}}
\begin{tabular}{|c|c|c|c|}\hline
...
\begin{center}
\begin{table}[h]
\caption{Torsion subgroups for curves with norm conductor up through 1831\label{table:degree}}
\begin{tabular}{|l|c|c|c|c|}\hline
\textbf{degree} & \textbf{\#isog} & \textbf{\#isom} & \textbf{example curve} & $\n$ \\\hline
None & 498 & 498  & \\\hline
2    & 652 & 2298 & \\\hline
3    & 289 & 950  & \\\hline
5    & 65  & 158  & \\\hline
