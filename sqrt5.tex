...
\left(-2 \varphi{}\right)x$. For any curve $E$, the equation for the twist $X_E(7)$ was found
Halberstadt and Kraus \cite{halb_kraus:XE7}, and also by Fisher \cite{fisher:families_cong}
through other methods which additionally yield formulas for $X_E(9)$ and $X_E(11)$.
