...
%OR
%Assuming $\ell  \mid \# E'(F)_{\tor}$, from the injectivity of the
%reduction map at good primes \cite{silverman:aec}[VII.~\S3] we have that
%$\ell \mid \#\tilde E'(\F_\p) = \bN(\p)+1 - a_{\p}$.
\end{proof}
